...
parser.add_argument("--puzzle", type=str, 
    help="File containing JSON description of puzzle")

parser.add_argument("--eprimeparam", type=str,
    help="savilerow param file")

parser.add_argument("--eprime", type=str, 
    help="savilerow eprime file")
...
parser.add_argument("--skip", type=int, default=0,
    help="Skip displaying MUSes of <= this size")

parser.add_argument("--merge", type=int, default=1,
    help="Merge MUSes of <= this size")

parser.add_argument("--incomplete", action="store_true", 
    help="allow problems with multiple solutions")

parser.add_argument("--steps", type=int, default=float('inf'), 
    help="How many steps to perform" )

parser.add_argument("--nodomains", action="store_true", 
    help="Only assign variables, do not remove domain values")

parser.add_argument("--force", type=str, action='append', default=None, 
    help="choose first non-trivial variable to be assigned")

parser.add_argument("--json", type=str, action='append', default=None, 
    help="optional JSON file output")

parser.add_argument("--forqes", action="store_true", default=None, 
