...
demystify.config.LoadConfigFromDict({"cores": 12, "smallRepeats": 5, "repeats": 200})

demystify.config.LoadConfigFromDict({"cores": 12, "smallRepeats": 5, "repeats": 20, "useUnsatCores": False})

demystify.config.LoadConfigFromDict({"solveLimited": False})
...
doSingleStep(sudokudoms,[((2,4),5)])
doSingleStep(sudokudoms)

sudokudoms = [[[1,4,5],[1,5],[7],[2,5],[8],[3],[6],[1,4,9],[1,2,4,9]],[[1,4,5],[3],[9],[7],[2,5],[6],[8],[1,4],[1,2,4]],[[8],[2],[6],[4],[1],[9],[7],[5],[3]],[[6],[4],[2,5],[1],[9],[2,5],[3],[8],[7]],[[1,5,9],[8],[1,2],[3],[6],[7],[2,4,5],[1,4,9],[1,4,5,9]],[[1,9],[7],[3],[2,5],[4],[8],[2,5],[6],[1,9]],[[3],[9],[1,5],[8],[7],[1,4],[4,5],[2],[6]],[[7],[6],[4],[9],[2,5],[2,5],[1],[3],[8]],[[2],[1,5],[8],[6],[3],[1,4],[9],[7],[4,5]]]
print("<hr><h2>Simple Colouring (single chains) - Twice in a unit</h2>")
doSingleStep(sudokudoms,[((0,1),5)])
doSingleStep(sudokudoms)
