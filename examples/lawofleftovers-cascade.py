...
constraints += buildpuz.buildCage("Cage 1", [vars[x][y] for (x,y) in [(i,j) for i in range(3) for j in range(3)]], vars.domain())
constraints += buildpuz.buildCage("Cage 2", [vars[x][y] for (x,y) in [(0,3),(0,4),(0,5),(0,6),(0,7),(1,3),(1,4),(1,5),(1,6)]], vars.domain())
