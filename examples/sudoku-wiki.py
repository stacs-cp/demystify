...
demystify.config.LoadConfigFromDict({"cores": 12, "smallRepeats": 2, "repeats": 50, "gallopingMUSes": True})
...
if False:
    ...
    print("<hr><h2>Y-Wing 1</h2>")
    doSingleStep(sudokudoms,[((7,2),4)])
    doSingleStep(sudokudoms)
    ...
    print("<hr><h2>Y-Wing 2</h2>")
    doSingleStep(sudokudoms,[((6,3),4)]) # ((6,5),4)
    doSingleStep(sudokudoms)
    ...
    print("<hr><h2>Swordfish 1</h2>")
    doSingleStep(sudokudoms,[((1,1),8)]) 
    doSingleStep(sudokudoms)
    ...
    print("<hr><h2>Swordfish 2</h2>")
    doSingleStep(sudokudoms,[((6,6),9)]) 
    doSingleStep(sudokudoms)
    ...
    print("<hr><h2>Swordfish 3</h2>")
    doSingleStep(sudokudoms,[((1,8),4)]) 
    doSingleStep(sudokudoms)
    ...
    print("<hr><h2>XYZ Wing 1</h2>")
    doSingleStep(sudokudoms,[((5,6),1)]) 
    doSingleStep(sudokudoms)
    ...
    print("<hr><h2>XYZ Wing 2</h2>")
    doSingleStep(sudokudoms,[((4,8),6)]) 
    doSingleStep(sudokudoms)
    ...
    print("<hr><h2>X-Cycle (part 1)</h2>")
    doSingleStep(sudokudoms,[((2,2),8)]) 
    doSingleStep(sudokudoms)
    ...
    print("<hr><h2>X-Cycle (part 2) - fig 1</h2>")
    doSingleStep(sudokudoms,[((8,0),9)]) 
    doSingleStep(sudokudoms)
    ...
    print("<hr><h2>X-Cycle (part 2) - fig 2</h2>")
    doSingleStep(sudokudoms,[((4,6),7)]) 
    doSingleStep(sudokudoms)
...
print("<hr><h2>X-Cycle (part 2) - fig 3</h2>")
doSingleStep(sudokudoms,[((1,6),8)]) 
doSingleStep(sudokudoms)
